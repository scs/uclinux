...
//document.write("<input class=text type=text  value="" name=streamserver>");
//document.write("<input type=button  value="" <a class=row href=ps.cgi?mpcadd+"+streamserver.value+"]&"+"</a>");
...
document.write("<tr><TD class=thead align=center>Artist</TD><TD class=thead align=center>Title</TD><TD class=thead align=center>Album</TD></TR>");
