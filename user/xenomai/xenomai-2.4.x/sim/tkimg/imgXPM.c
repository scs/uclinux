...
static int		ChanMatchXPM _ANSI_ARGS_((Tcl_Interp *interp,
...
Tk_PhotoImageFormat imgFmtXPM = {
    ...
    (Tk_ImageFileWriteProc *) FileWriteXPM,	/* fileWriteProc */
 ...
 */
static int
ObjMatchXPM(interp, data, format, widthPtr, heightPtr)
    Tcl_Interp *interp;
