...
#include <stdlib.h>
#include "tcl.h"
/* rubens - please look for other changes here in this file;
   I am trying to remove a dependency on this internal header
   file...
*/
/*  #include "tclInt.h" */
    ...
    int **height;
{
  ...
  /* rubens
     I dont know why this was here - it is a dependency
     on tclInt.h. I will try to remove it.
