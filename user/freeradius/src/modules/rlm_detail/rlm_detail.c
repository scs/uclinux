 ...
 *
 * Version:	$Id: rlm_detail.c,v 1.37.2.1.2.1 2006/04/19 18:35:41 aland Exp $
 *
...
static const char rcsid[] = "$Id: rlm_detail.c,v 1.37.2.1.2.1 2006/04/19 18:35:41 aland Exp $";
