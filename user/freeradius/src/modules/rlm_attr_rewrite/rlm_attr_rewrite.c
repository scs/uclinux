 ...
 * rlm_attr_rewrite.c
 *
 * Version:  $Id: rlm_attr_rewrite.c,v 1.21.2.1 2005/05/22 18:16:56 nbk Exp $
 *
...
static const char rcsid[] = "$Id: rlm_attr_rewrite.c,v 1.21.2.1 2005/05/22 18:16:56 nbk Exp $";
