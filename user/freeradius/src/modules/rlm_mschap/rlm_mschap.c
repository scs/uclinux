 ...
 * rlm_mschap.c
 *
 * Version:	$Id: rlm_mschap.c,v 1.59.2.3.2.2 2006/04/13 16:28:30 aland Exp $
 *
...
static const char rcsid[] = "$Id: rlm_mschap.c,v 1.59.2.3.2.2 2006/04/13 16:28:30 aland Exp $";
