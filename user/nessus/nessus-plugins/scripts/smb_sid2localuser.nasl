...
__no_enum = get_kb_item("SMB/LocalUsers/0");
if(__no_enum)exit(0);

__no_enum = get_kb_item("SMB/LocalUsers/1");
if(__no_enum)exit(0);
...
report = string("The host SID could be used to enumerate the names of the local users\n",
		"of this host. \n",
