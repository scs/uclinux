...
/* incrPlaylistVersion - static variables are thread-safe */
static void incrPlaylistVersion() {
	static const unsigned long max = ((mpd_uint32)1<<31)-1;
	playlist.version++;
...
/* getNextId - static variables are thread-safe */
...
/* previousSongInPlaylist - (thread-safe) */
