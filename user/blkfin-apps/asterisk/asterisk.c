...
int main(int argc, char *argv[])
{
	...
	/* DR: start static modules support */
	...
	*/
	...
	if (!option_verbose && !option_debug && !option_nofork && !option_console) {
		...
		printf("Daemon mode not supported in uCasterisk ....exiting!\n");
		printf("try ./asterisk -vvvc, or pls help implement "
		       "daemon mode under uClinux :-) \n");
		exit(0);
