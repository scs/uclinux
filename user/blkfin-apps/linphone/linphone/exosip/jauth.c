				     ...
				     osip_authorization_t **auth)
{
  ...
  {   
    ...
    const char * pszUser = osip_strdup_without_quote(username);
    ...
    const char * pszMethod = osip_strdup_without_quote(previous_answer->cseq->method);
    char * pszQop = NULL;
    const char * pszURI = osip_strdup_without_quote(rquri);
