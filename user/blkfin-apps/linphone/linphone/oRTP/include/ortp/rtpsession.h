...
void rtp_session_set_symmetric_rtp (RtpSession * session, int yesno);
...
int rtp_session_recv_with_ts(RtpSession *session, uint8_t *buffer, int len, uint32_t time, int *have_more);
