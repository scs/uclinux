...
CPP_PROJ=/nologo /MT /W3 /Od /I "$(PATH_2_SSL_INCLUDE)" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "USE_WIN32" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\stunnel.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=wsock32.lib ssleay32.lib libeay32.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\stunnel.pdb" /machine:I386 /out:"$(OUTDIR)\stunnel.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\log.obj" \
	"$(INTDIR)\sthreads.obj" \
	"$(INTDIR)\stunnel.obj"
