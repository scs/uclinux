 ...
 ****************************************************************************************
  ...
  Description  : This file contains the code for the implementation of IFFT.
		 ...
		 imaginary parts are swapped with each other. Then the FFT computation is
...
Performance:
	     The Code Size = 456 Bytes.
	     The Cycle count for N = 64   = 1132 cycles.
...
*/
	...
	R5 = [I1];
	R6.H = (A1 += R3.H *R6.L), R6.L = (A0 -= R3.H * R6.H) || R3 = [I3++M1];
	[I2++] = R4;
