 ...
 ******************************************************************************
  File Name    : cr2x2fftnasm.asm
  Module Name  : Two dimensional radix 2x2 forward FFT for complex data.
...
/************************ Program Section ****************************************/
//The name for the Radix 2x2 FFT label is __cfft2d_fr16.
...
/***************** Implementation of First Stage **********************************/
	...
	R1 = R1 + R2 (NS)  || I1 += M1;
		 //I1 stores the Odd-even address of butterfly.
	M0 = R1;
