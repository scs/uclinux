 ...
 ******************************************************************************
  ...
  Description     : This program finds minimum number in a given fractinal input vector.
