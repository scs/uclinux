...
!MESSAGE 
!MESSAGE NMAKE /f "ftpsend.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/ftpsend.exe $(OUTDIR)/ftpsend.bsc
...
CPP_PROJ=/nologo /ML /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"ftpsend.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"ftpsend.bsc" 
BSC32_SBRS= \
	$(INTDIR)/ftpsend.sbr

$(OUTDIR)/ftpsend.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=winrel/ftplib.lib wsock32.lib /NOLOGO /SUBSYSTEM:console\
 /INCREMENTAL:no /PDB:$(OUTDIR)/"ftpsend.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"ftpsend.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/ftpsend.obj

$(OUTDIR)/ftpsend.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /ML /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"ftpsend.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"ftpsend.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=windebug/ftplib.lib wsock32.lib /NOLOGO /SUBSYSTEM:console\
 /INCREMENTAL:yes /PDB:$(OUTDIR)/"ftpsend.pdb" /DEBUG /MACHINE:I386\
 /OUT:$(OUTDIR)/"ftpsend.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/ftpsend.obj
...
$(INTDIR)/ftpsend.obj :  $(SOURCE)  $(INTDIR)
