...
!MESSAGE 
!MESSAGE NMAKE /f "ftpget.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/ftpget.exe $(OUTDIR)/ftpget.bsc
...
CPP_PROJ=/nologo /ML /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"ftpget.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"ftpget.bsc" 
BSC32_SBRS= \
	$(INTDIR)/ftpget.sbr

$(OUTDIR)/ftpget.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=winrel/ftplib.lib wsock32.lib /NOLOGO /SUBSYSTEM:console\
 /INCREMENTAL:no /PDB:$(OUTDIR)/"ftpget.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"ftpget.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/ftpget.obj

$(OUTDIR)/ftpget.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /ML /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"ftpget.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"ftpget.pdb"\
 /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=windebug/ftplib.lib wsock32.lib /NOLOGO /SUBSYSTEM:console\
 /INCREMENTAL:yes /PDB:$(OUTDIR)/"ftpget.pdb" /DEBUG /MACHINE:I386\
 /OUT:$(OUTDIR)/"ftpget.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/ftpget.obj
...
$(INTDIR)/ftpget.obj :  $(SOURCE)  $(INTDIR)
