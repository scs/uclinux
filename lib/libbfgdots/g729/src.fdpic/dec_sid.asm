...
_Dec_cng:
	...
	[--SP] = P3;
	P3 = M2;
	R0 = [P3+Dec_sid_sid_gain@GOT17M4];
	I1 = R0
	P3 = [SP++];
	R0 = [SP++];
	[--SP] = R0;
...
Dec_cng3:
	...
	[--SP] = P3;
	P3 = M2;
	R0 = [P3+Dec_sid_cur_gain@GOT17M4];
	I1 = R0
	P3 = [SP++];
	R0 = [SP++];
		 R4.H = 1;
