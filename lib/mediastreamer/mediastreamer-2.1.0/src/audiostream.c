...
AudioStream * audio_stream_start_with_files(RtpProfile *prof,int locport,const char *remip, int remport,int pt,int jitt_comp, const char *infile, const char * outfile)
{
	return audio_stream_start_full(prof,locport,remip,remport,pt,jitt_comp,infile,outfile,NULL,NULL,FALSE);
}
...
AudioStream * audio_stream_start(RtpProfile *prof,int locport,const char *remip,int remport,int profile,int jitt_comp,bool_t use_ec)
{
	...
	if (sndcard==NULL)
		return NULL;
	return audio_stream_start_full(prof,locport,remip,remport,profile,jitt_comp,NULL,NULL,sndcard,sndcard,use_ec);
}
