...
#define CONFIG_DEFAULTS_ANALOGDEVICES 1
...
#undef  CONFIG_DEFAULTS_ANALOGDEVICES_BF533_EZKIT
#define CONFIG_DEFAULTS_ANALOGDEVICES_BF533_STAMP 1
#undef  CONFIG_DEFAULTS_ANALOGDEVICES_BF537_EZKIT
