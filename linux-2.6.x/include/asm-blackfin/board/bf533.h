...
#define PLLCTL_ADDR			0xffc00000  /* PLL control register 32 bit*/
#define PLLCTL				HALFWORD_REF(PLLCTL_ADDR)
#define PLLSTAT_ADDR			0xffc0000c  /* PLL status register 16 bit */
#define PLLSTAT				HALFWORD_REF(PLLSTAT_ADDR)
#define LOCKCNT_ADDR			0xffc00010  /* PLL lock counter register 16 bit */
#define LOCKCNT				HALFWORD_REF(LOCKCNT_ADDR)
#define SWRST_ADDR			0xffc00100  /* Software reset register 16 bit */
#define SWRST				HALFWORD_REF(SWRST_ADDR)
#define SYSCR_ADDR			0xffc00104  /* Sytem Configuration register */
#define SYSCR 				HALFWORD_REF(SYSCR_ADDR)
#define PLLDIV_ADDR			0xffc00004  /* PLL control register 32 bit*/
#define PLLDIV				HALFWORD_REF(PLLDIV_ADDR)

#define VRCTL_ADDR			0xffc00008 /* PLL control register 32 bit*/
#define VRCTL				HALFWORD_REF(VRCTL_ADDR)
/**************************
 *
...
#define WDOGCTL_ADDR		0xffc00200  /* Watchdog control register  32 bit */
#define WDOGCTL				WORD_REF(WDOGCTL_ADDR)
#define WDOGCNT_ADDR		0xffc00204  /* Watchdog count register 32 bit */
#define WDOGCNT				WORD_REF(WDOGCNT_ADDR)
#define WDOGSTAT_ADDR		0xffc00208  /* Watchdog status register 32 bit */
...
#define RTCSTAT_ADDR		0xffc00300  /* RTC status register  32 bit */
#define RTCSTAT				WORD_REF(RTCSTAT_ADDR)
#define RTCICTL_ADDR		0xffc00304  /* RTC Interrupt control register  32 bit */
#define RTCICTL				WORD_REF(RTCICTL_ADDR)
#define RTCISTAT_ADDR		0xffc00308  /* RTC Interrupt status register  32 bit */
#define RTCISTAT			WORD_REF(RTCISTAT_ADDR)
#define RTCSWCNT_ADDR		0xffc0030c  /* RTC Stop watch count register  32 bit */
#define RTCSWCNT			WORD_REF(RTCSWCNT_ADDR)
#define RTCALARM_ADDR		0xffc00310  /* RTC Alarm time register  32 bit */
#define RTCALARM			WORD_REF(RTCALARM_ADDR)
#define RTCPREN_ADDR		0xffc00314  /* RTC Prescalar control register  32 bit */
#define RTCPREN				WORD_REF(RTCFAST_ADDR)
...
#define UART0_THR_ADDR		0xffc00400  /* UART 0 Transmit holding register  16 bit */
#define UART0_THR			HALFWORD_REF(UART0_THR_ADDR)
#define UART0_THR_MASK		0x00ff /* Data to be transmitted */ 

#define UART0_RBR_ADDR		0xffc00400  /* UART 0 Receive buffer register  16 bit */
#define UART0_RBR			HALFWORD_REF(UART0_RBR_ADDR)
#define UART0_RBR_MASK		0x00ff /* Data to be received */ 

#define UART0_DLL_ADDR		0xffc00400  /* UART 0 Divisor latch (low byte) register  16 bit */
#define UART0_DLL			HALFWORD_REF(UART0_DLL_ADDR)

#define UART0_IER_ADDR		0xffc00404  /* UART 0 Interrupt enable register  16 bit */
...
#define UART0_DLH_ADDR		0xffc00400  /* UART 0 Divisor latch (high byte) register  16 bit */
#define UART0_DLH			HALFWORD_REF(UART0_DLH_ADDR)
#define UART0_IIR_ADDR		0xffc00408  /* UART 0 Interrupt identification register  16 bit */
...
#define UART0_LCR_ADDR		0xffc0040c  /* UART 0 Line control register  16 bit */
...
#define UART0_MCR_ADDR		0xffc00410  /* UART 0 Module Control register  16 bit */
#define UART0_MCR			HALFWORD_REF(UART0_MCR_ADDR)

#define UART0_LSR_ADDR		0xffc00414  /* UART 0 Line status register  16 bit */
...
#define UART0_SCR_ADDR		0xffc0041c  /* UART 0 Scratch register  16 bit */
...
#define TIMER_STATUS_ADDR		0xffc00648 /* TIMER 2 Global status & sticky register  16 bit */
#define TIMER_STATUS			HALFWORD_REF(TIMER_STATUS_ADDR)
#define TIMER0_CONFIG_ADDR		0xffc00600 /* TIMER 0 configuration register  16 bit */
#define TIMER0_CONFIG			HALFWORD_REF(TIMER0_CONFIG_ADDR)
#define TIMER0_COUNTER_ADDR		0xffc00604 /* TIMER 0 counter (low word) register   16 bit */
#define TIMER0_COUNTER			HALFWORD_REF(TIMER0_COUNTER_ADDR)
#define TIMER0_PERIOD_ADDR		0xffc00608 /* TIMER 0 period (low word) register  16 bit */
#define TIMER0_PERIOD			HALFWORD_REF(TIMER0_PERIOD_ADDR)
#define TIMER0_WIDTH_ADDR		0xffc0060c /* TIMER 0 width (low word) register  16 bit */
#define TIMER0_WIDTH			HALFWORD_REF(TIMER0_WIDTH_ADDR)

		/*             TIMER 1              */

#define TIMER1_CONFIG_ADDR		0xffc00610 /* TIMER 1 configuration register  16 bit */
#define TIMER1_CONFIG			HALFWORD_REF(TIMER1_CONFIG_ADDR)
#define TIMER1_COUNTER_ADDR		0xffc00614 /* TIMER 1 counter (low word) register   16 bit */
#define TIMER1_COUNTER			HALFWORD_REF(TIMER1_COUNTER_ADDR)
#define TIMER1_PERIOD_ADDR		0xffc00618 /* TIMER 1 period (low word) register  16 bit */
#define TIMER1_PERIOD			HALFWORD_REF(TIMER1_PERIOD_ADDR)
#define TIMER1_WIDTH_ADDR		0xffc0061c /* TIMER 1 width (low word) register  16 bit */
#define TIMER1_WIDTH			HALFWORD_REF(TIMER1_WIDTH_ADDR)

		/*             TIMER 2              */

#define TIMER2_CONFIG_ADDR		0xffc00620 /* TIMER 2 configuration register  16 bit */
#define TIMER2_CONFIG			HALFWORD_REF(TIMER2_CONFIG_ADDR)
#define TIMER2_COUNTER_ADDR		0xffc00624 /* TIMER 2 counter (low word) register   16 bit */
#define TIMER2_COUNTER			HALFWORD_REF(TIMER2_COUNTER_ADDR)
#define TIMER2_PERIOD_ADDR		0xffc00628 /* TIMER 2 period (low word) register  16 bit */
#define TIMER2_PERIOD			HALFWORD_REF(TIMER2_PERIOD_ADDR)
#define TIMER2_WIDTH_ADDR		0xffc0062c /* TIMER 2 width (low word) register  16 bit */
#define TIMER2_WIDTH			HALFWORD_REF(TIMER2_WIDTH_ADDR)

/****************************
 *
 *  GENERAL PURBITE IO REGISTERS  (0XFFC02400 - 0XFFC027FF)
 *       
 ****************************/

#define FIO_DIR_ADDR		0xffc00730 /* Peripheral flag direction (clear) register 16 bit */
#define FIO_DIR			HALFWORD_REF(FIO_DIR_ADDR)
...
#define FIO_FLAG_D_ADDR		0xffc00700 /* Peripheral Interrupt flag (clear) register 16 bit */
#define FIO_FLAG_D			HALFWORD_REF(FIO_FLAG_D_ADDR)
#define FIO_FLAG_C_ADDR		0xffc00704 /* Peripheral Interrupt flag (clear) register 16 bit */
#define FIO_FLAG_C			HALFWORD_REF(FIO_FLAG_C_ADDR)
#define FIO_FLAG_S_ADDR		0xffc00708 /* Peripheral Interrupt flag (set) register 16 bit */
#define FIO_FLAG_S			HALFWORD_REF(FIO_FLAG_S_ADDR)
#define FIO_MASKA_D_ADDR	0xffc00710 /* Flag Mask Interrupt A (clear) register 16 bit */
#define FIO_MASKA_D			HALFWORD_REF(FIO_MASKA_D_ADDR)
#define FIO_MASKA_C_ADDR	0xffc00714 /* Flag Mask Interrupt A (clear) register 16 bit */
#define FIO_MASKA_C			HALFWORD_REF(FIO_MASKA_C_ADDR)
#define FIO_MASKA_S_ADDR	0xffc00718 /* Flag Mask Interrupt A (set) register 16 bit */
#define FIO_MASKA_S			HALFWORD_REF(FIO_MASKA_S_ADDR)
#define FIO_MASKA_T_ADDR	0xffc0071C /* Flag Mask Interrupt A (set) register 16 bit */
#define FIO_MASKA_T			HALFWORD_REF(FIO_MASKA_T_ADDR)

#define FIO_MASKB_D_ADDR	0xffc00720 /* Flag Mask Interrupt B (clear) register 16 bit */
#define FIO_MASKB_D			HALFWORD_REF(FIO_MASKB_D_ADDR)
#define FIO_MASKB_C_ADDR	0xffc00724 /* Flag Mask Interrupt B (clear) register 16 bit */
#define FIO_MASKB_C			HALFWORD_REF(FIO_MASKB_C_ADDR)
#define FIO_MASKB_S_ADDR	0xffc00728 /* Flag Mask Interrupt B (set) register 16 bit */
#define FIO_MASKB_S			HALFWORD_REF(FIO_MASKB_S_ADDR)
#define FIO_POLAR_ADDR		0xffc00734 /* Flag source polarity (clear) register 16 bit */
#define FIO_POLAR			HALFWORD_REF(FIO_POLAR_ADDR)
#define FIO_EDGE_ADDR		0xffc00738 /* Flag source sensitivity (clear) register 16 bit */
#define FIO_EDGE			HALFWORD_REF(FIO_EDGE_ADDR)
#define FIO_BOTH_ADDR		0xffc0073c /* Flag set on both edges (clear) register 16 bit */
#define FIO_BOTH			HALFWORD_REF(FIO_BOTH_ADDR)
#define FIO_INEN_ADDR		0xffc00740 /* Flag set on both edges (clear) register 16 bit */
#define FIO_INEN			HALFWORD_REF(FIO_INEN_ADDR)
...
#define EBIU_AMGCTL_ADDR	0xffc00a00 /* Asynchronous memory global control register ? bit */
#define EBIU_AMGCTL			HALFWORD_REF(EBIU_AMGCTL_ADDR)
#define EBIU_AMBCTL0_ADDR	0xffc00a04 /* Asynchronous memory bank control register 0 32 bit */
#define EBIU_AMBCTL0			WORD_REF(EBIU_AMBCTL0_ADDR)
#define EBIU_AMBCTL1_ADDR	0xffc00a08 /* Asynchronous memory bank control register 1 32 bit */
#define EBIU_AMBCTL1			WORD_REF(EBIU_AMBCTL1_ADDR)
...
#define EBIU_SDGCTL_ADDR	0xffc00a10 /* SDRAM Memory global control register 32 bit */
#define EBIU_SDGCTL		WORD_REF(EBIU_SDGCTL_ADDR)
#define EBIU_SDBCTL_ADDR	0xffc00a14 /* SDRAM Memory bank control register 32 bit */
#define EBIU_SDBCTL		WORD_REF(EBIU_SDBCTL_ADDR)
#define EBIU_SDRRC_ADDR		0xffc00a18 /* SDRAM Memory refresh rate count register 16 bit */
#define EBIU_SDRRC		HALFWORD_REF(EBIU_SDRRC_ADDR)
#define EBIU_SDSTAT_ADDR	0xffc00a18 /* SDRAM control status register 16 bit */
...
/*#define IMEM_CONTROL           WORD_REF(0xFFE01004)  */
...
#define ICPLB_STATUS		WORD_REF(0xFFE01008)	/*Instruction Cache miss status*/
#define ICPLB_FAULT_ADDR	(0xFFE0100C)		/*Instruction Cache miss address*/
/*#define ICPLB_ADDR0		WORD_REF(0xFFE01100)*/  /*Instruction Cacheability Protection Lookaside Buffer 0*/
#define ICPLB_ADDR0		0xFFE01100  		/*Instruction Cacheability Protection Lookaside Buffer 0*/
#define ICPLB_ADDR1		WORD_REF(0xFFE01104)	/*Instruction Cacheability Protection Lookaside Buffer 1*/
#define ICPLB_ADDR2		WORD_REF(0xFFE01108)	/*Instruction Cacheability Protection Lookaside Buffer 2*/
#define ICPLB_ADDR3		WORD_REF(0xFFE0110C) 	/*Instruction Cacheability Protection Lookaside Buffer 3*/
#define ICPLB_ADDR4		WORD_REF(0xFFE01110)	/*Instruction Cacheability Protection Lookaside Buffer 4*/
#define ICPLB_ADDR5		WORD_REF(0xFFE01114)	/*Instruction Cacheability Protection Lookaside Buffer 5*/
#define ICPLB_ADDR6		WORD_REF(0xFFE01118)	/*Instruction Cacheability Protection Lookaside Buffer 6*/
#define ICPLB_ADDR7		WORD_REF(0xFFE0111C)	/*Instruction Cacheability Protection Lookaside Buffer 7*/
#define ICPLB_ADDR8		WORD_REF(0xFFE01120)	/*Instruction Cacheability Protection Lookaside Buffer 8*/
#define ICPLB_ADDR9		WORD_REF(0xFFE01124)	/*Instruction Cacheability Protection Lookaside Buffer 9*/
#define ICPLB_ADDRA		WORD_REF(0xFFE01128)	/*Instruction Cacheability Protection Lookaside Buffer 10*/
#define ICPLB_ADDRB		WORD_REF(0xFFE0112C)	/*Instruction Cacheability Protection Lookaside Buffer 11*/
#define ICPLB_ADDRC		WORD_REF(0xFFE01130)	/*Instruction Cacheability Protection Lookaside Buffer 12*/
#define ICPLB_ADDRD		WORD_REF(0xFFE01134)	/*Instruction Cacheability Protection Lookaside Buffer 13*/
#define ICPLB_ADDRE		WORD_REF(0xFFE01138)	/*Instruction Cacheability Protection Lookaside Buffer 14*/
#define ICPLB_ADDRF		WORD_REF(0xFFE0113C)	/*Instruction Cacheability Protection Lookaside Buffer 15*/

#define ICPLB_DATA0		0xFFE01200		/*Instruction Cache 0 Status*/
/*#define ICPLB_DATA0            WORD_REF(0xFFE01200)*/	/*Instruction Cache 1 Status*/
#define ICPLB_DATA1            WORD_REF(0xFFE01204)	/*Instruction Cache 1 Status*/
#define ICPLB_DATA2            WORD_REF(0xFFE01208)	/*Instruction Cache 2 Status*/
#define ICPLB_DATA3            WORD_REF(0xFFE0120C)	/*Instruction Cache 3 Status*/
#define ICPLB_DATA4            WORD_REF(0xFFE01210)	/*Instruction Cache 4 Status*/
#define ICPLB_DATA5            WORD_REF(0xFFE01214)	/*Instruction Cache 5 Status*/
#define ICPLB_DATA6            WORD_REF(0xFFE01218)	/*Instruction Cache 6 Status*/
#define ICPLB_DATA7            WORD_REF(0xFFE0121C)	/*Instruction Cache 7 Status*/
#define ICPLB_DATA8            WORD_REF(0xFFE01220)	/*Instruction Cache 8 Status*/
#define ICPLB_DATA9            WORD_REF(0xFFE01224)	/*Instruction Cache 9 Status*/
#define ICPLB_DATAA            WORD_REF(0xFFE01228)	/*Instruction Cache 10 Status*/
#define ICPLB_DATAB            WORD_REF(0xFFE0122C)	/*Instruction Cache 11 Status*/
#define ICPLB_DATAC            WORD_REF(0xFFE01230)	/*Instruction Cache 12 Status*/
#define ICPLB_DATAD            WORD_REF(0xFFE01234)	/*Instruction Cache 13 Status*/
#define ICPLB_DATAE            WORD_REF(0xFFE01238)	/*Instruction Cache 14 Status*/
/*#define ICPLB_DATAF		WORD_REF(0xFFE0123C)*/	/*Instruction Cache 14 Status*/
#define ICPLB_DATAF            (0xFFE0123C)		/*Instruction Cache 15 Status*/


#define SRAM_BASE_ADDRESS	WORD_REF(0xFFE00000)	/*SRAM Base Address Register*/
/*#define DMEM_CONTROL		WORD_REF(0xFFE00004)*/  /*Data memory control*/
#define DMEM_CONTROL		0xFFE00004		/*Data memory control*/
#define DCPLB_STATUS		(0xFFE00008)		/*Data Cache Programmable Look-Aside Buffer Status*/
#define DCPLB_FAULT_STATUS	WORD_REF(0xFFE00008)	/* "" (older define)*/
/*#define DCPLB_FAULT_ADDR	WORD_REF(0xFFE0000C)*/	/*Data Cache Programmable Look-Aside Buffer Fault Address*/
#define DCPLB_FAULT_ADDR	(0xFFE0000C)		/*Data Cache Programmable Look-Aside Buffer Fault Address*/
/*#define DCPLB_ADDR0		WORD_REF(0xFFE00100)*/	/*Data Cache Protection Lookaside Buffer 0*/
#define DCPLB_ADDR0		(0xFFE00100)		/*Data Cache Protection Lookaside Buffer 0*/
#define DCPLB_ADDR1		WORD_REF(0xFFE00104)	/*Data Cache Protection Lookaside Buffer 1*/
#define DCPLB_ADDR2		WORD_REF(0xFFE00108)	/*Data Cache Protection Lookaside Buffer 2*/
#define DCPLB_ADDR3		WORD_REF(0xFFE0010C)	/*Data Cacheability Protection Lookaside Buffer 3*/
#define DCPLB_ADDR4		WORD_REF(0xFFE00110)	/*Data Cacheability Protection Lookaside Buffer 4*/
#define DCPLB_ADDR5		WORD_REF(0xFFE00114)	/*Data Cacheability Protection Lookaside Buffer 5*/
#define DCPLB_ADDR6		WORD_REF(0xFFE00118)	/*Data Cacheability Protection Lookaside Buffer 6*/
#define DCPLB_ADDR7		WORD_REF(0xFFE0011C)	/*Data Cacheability Protection Lookaside Buffer 7*/
#define DCPLB_ADDR8		WORD_REF(0xFFE00120)	/*Data Cacheability Protection Lookaside Buffer 8*/
#define DCPLB_ADDR9		WORD_REF(0xFFE00124)	/*Data Cacheability Protection Lookaside Buffer 9*/
#define DCPLB_ADDRA		WORD_REF(0xFFE00128)	/*Data Cacheability Protection Lookaside Buffer 10*/
#define DCPLB_ADDRB		WORD_REF(0xFFE0012C)	/*Data Cacheability Protection Lookaside Buffer 11*/
#define DCPLB_ADDRC		WORD_REF(0xFFE00130)	/*Data Cacheability Protection Lookaside Buffer 12*/
#define DCPLB_ADDRD		WORD_REF(0xFFE00134)	/*Data Cacheability Protection Lookaside Buffer 13*/
#define DCPLB_ADDRE		WORD_REF(0xFFE00138)	/*Data Cacheability Protection Lookaside Buffer 14*/
#define DCPLB_ADDRF		WORD_REF(0xFFE0013C)	/*Data Cacheability Protection Lookaside Buffer 15*/

/*#define DCPLB_DATA0		WORD_REF(0xFFE00200)*/	/*Data Cache 0 Status*/
#define DCPLB_DATA0            (0xFFE00200)		/*Data Cache 0 Status*/
#define DCPLB_DATA1            WORD_REF(0xFFE00204)	/*Data Cache 1 Status*/
#define DCPLB_DATA2            WORD_REF(0xFFE00208)	/*Data Cache 2 Status*/
#define DCPLB_DATA3            WORD_REF(0xFFE0020C)	/*Data Cache 3 Status*/
#define DCPLB_DATA4            WORD_REF(0xFFE00210)	/*Data Cache 4 Status*/
#define DCPLB_DATA5            WORD_REF(0xFFE00214)	/*Data Cache 5 Status*/
#define DCPLB_DATA6            WORD_REF(0xFFE00218)	/*Data Cache 6 Status*/
#define DCPLB_DATA7            WORD_REF(0xFFE0021C)	/*Data Cache 7 Status*/
#define DCPLB_DATA8            WORD_REF(0xFFE00220)	/*Data Cache 8 Status*/
#define DCPLB_DATA9            WORD_REF(0xFFE00224)	/*Data Cache 9 Status*/
#define DCPLB_DATAA            WORD_REF(0xFFE00228)	/*Data Cache 10 Status*/
#define DCPLB_DATAB            WORD_REF(0xFFE0022C)	/*Data Cache 11 Status*/
#define DCPLB_DATAC            WORD_REF(0xFFE00230)	/*Data Cache 12 Status*/
#define DCPLB_DATAD            WORD_REF(0xFFE00234)	/*Data Cache 13 Status*/
#define DCPLB_DATAE            WORD_REF(0xFFE00238)	/*Data Cache 14 Status*/
/*#define DCPLB_DATAF		WORD_REF(0xFFE0023C)*/	/*Data Cache 15 Status*/
#define DCPLB_DATAF		(0xFFE0023C)		/*Data Cache 15 Status*/
#define DCPLB_DATAG		(0xFFE00240)		/*Data Cache 15 Status*/

/*#define DTEST_COMMAND          WORD_REF(0xFFE00300)*/	/*Data Test Command Register*/
#define DTEST_COMMAND		(0xFFE00300)		/*Data Test Command Register*/
#define DTEST_DATA0		(0xFFE00400)		/*Data Test Data Register*/
#define DTEST_DATA1		(0xFFE00404)		/*Data Test Data Register*/

/*#define DTEST_DATA0		WORD_REF(0xFFE00400)*/	/*Data Test Data Register*/
/*#define DTEST_DATA1		WORD_REF(0xFFE00404)*/	/*Data Test Data Register*/
...
#define ENDCPLB (1<<1)
#define DMC_531_ENABLE (2<<2)	/*yes, 2, not 1*/

#define CPLB_L1_AOW	(1<<15)
#define CPLB_L1_WT	(1<<14)
#define CPLB_L1_CHBL	(1<<12)
#define CPLB_DIRTY	(1<<7)

#define CPLB_PAGESIZE_1K (0<<16)
#define CPLB_PAGESIZE_4K (1<<16)
#define CPLB_PAGESIZE_1M (2<<16)
#define CPLB_PAGESIZE_4M (3<<16)

#define CPLB_LRUPRIO (1<<8)
#define CPLB_SUPV_WR (1<<4)
#define CPLB_USER_WR (1<<3)
#define CPLB_USER_RD (1<<2)
#define CPLB_LOCK    (1<<1)
#define CPLB_VALID   (1)
...
#define SIC_IAR0_ADDR		0xffc00110
#define SIC_IAR0		WORD_REF(SIC_IAR0_ADDR)

#define SIC_IAR1_ADDR		0xffc00114
#define SIC_IAR1		WORD_REF(SIC_IAR1_ADDR)

#define SIC_IAR2_ADDR		0xffc00118
#define SIC_IAR2		WORD_REF(SIC_IAR2_ADDR)

#define SIC_IAR3_ADDR		0xffc0011c
#define SIC_IAR3		WORD_REF(SIC_IAR3_ADDR)
