...
#define UART_DLH		HALFWORD_REF(UART_DLH_ADDR)
#define UART_IIR_ADDR		0xffc00408  /* UART 0 Interrupt identification register  16 bit */
#define UART_IIR		HALFWORD_REF(UART_IIR_ADDR)
...
#define UART_LCR           	HALFWORD_REF(UART_LCR_ADDR)
...
#define UART_MCR_ADDR          	0xffc00410  /* UART 0 Module Control register  
					       16 bit */
#define UART_MCR           	HALFWORD_REF(UART_MCR_ADDR)

#define UART_LSR_ADDR          	0xffc00414  /* UART 0 Line status register  
					       16 bit */
#define UART_LSR           	HALFWORD_REF(UART_LSR_ADDR)
...
#define UART_MSR           	HALFWORD_REF(UART_MSR_ADDR)
#define UART_SCR_ADDR          	0xffc00418  /* UART 0 Scratch register  16 bit */
#define UART_SCR           	HALFWORD_REF(UART_SCR_ADDR)
