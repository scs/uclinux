...
#define SYS_IRQS		72		/* Number of interrupts	    */
...
/* IAR0 BIT FIELDS */
#define	PLL_WAKEUP_POS			0
#define	DMA1_ERROR_POS			4
#define	DMA2_ERROR_POS			8
#define IMDMA_ERROR_POS			12
#define	PPI1_ERROR_POS			16
#define	PPI2_ERROR_POS			20
#define	SPORT0_ERROR_POS		24
#define	SPORT1_ERROR_POS		28
/* IAR1 BIT FIELDS */
#define	SPI_ERROR_POS			0
#define	UART_ERROR_POS			4
#define RESERVED_ERROR_POS		8
#define	DMA1_0_POS			12
#define	DMA1_1_POS			16
#define	DMA1_2_POS			20
#define	DMA1_3_POS			24
#define	DMA1_4_POS			28
/* IAR2 BIT FIELDS */
#define	DMA1_5_POS			0
#define	DMA1_6_POS			4
#define	DMA1_7_POS			8
#define	DMA1_8_POS			12
#define	DMA1_9_POS			16
#define	DMA1_10_POS			20
#define	DMA1_11_POS			24
#define	DMA2_0_POS			28
/* IAR3 BIT FIELDS */
#define	DMA2_1_POS			0
#define	DMA2_2_POS			4
#define	DMA2_3_POS			8
#define	DMA2_4_POS			12
#define	DMA2_5_POS			16
#define	DMA2_6_POS			20
#define	DMA2_7_POS			24
#define	DMA2_8_POS			28
/* IAR4 BIT FIELDS */
#define	DMA2_9_POS			0
#define	DMA2_10_POS			4
#define	DMA2_11_POS			8
#define TIMER0_POS			12
#define TIMER1_POS			16
#define TIMER2_POS			20
#define TIMER3_POS			24
#define TIMER4_POS			28
/* IAR5 BIT FIELDS */
#define TIMER5_POS			0
#define TIMER6_POS			4
#define TIMER7_POS			8
#define TIMER8_POS			12
#define TIMER9_POS			16
#define TIMER10_POS			20
#define TIMER11_POS			24
#define	PROG0_INTA_POS			28
/* IAR6 BIT FIELDS */
#define	PROG0_INTB_POS			0
#define	PROG1_INTA_POS			4
#define	PROG1_INTB_POS			8
#define	PROG2_INTA_POS			12
#define	PROG2_INTB_POS			16
#define DMA1_WRRD0_POS			20
#define DMA1_WRRD1_POS			24
#define DMA2_WRRD0_POS			28
/* IAR7 BIT FIELDS */
#define DMA2_WRRD1_POS			0
#define IMDMA_WRRD0_POS			4
#define IMDMA_WRRD1_POS			8
#define	WDTIMER_POS			12
#define RESERVED_1_POS			16
#define RESERVED_2_POS			20
#define SUPPLE_0_POS			24
#define SUPPLE_1_POS			28

#if 1 	/* comment by mhfan */
#define	IRQ_DMA_ERROR		(IVG_BASE + 1)	/* DMA1	  Error (general)   */
#define	IRQ_PPI_ERROR		(IVG_BASE + 4)	/* PPI1	  Error Interrupt   */
#define	IRQ_PPI			(IVG_BASE + 11)	/* DMA1 0  Interrupt(PPI1)  */
#define	IRQ_PPI1		(IVG_BASE + 11)	/* DMA1 0  Interrupt(PPI1)  */
#define	IRQ_PPI2		(IVG_BASE + 12)	/* DMA1 1  Interrupt(PPI2)  */
#define	IRQ_SPORT0_RX		(IVG_BASE + 23)	/* DMA2 0  (SPORT0 RX)	    */
#define	IRQ_SPORT0_TX		(IVG_BASE + 24)	/* DMA2 1  (SPORT0 TX)	    */
#define	IRQ_SPORT1_RX		(IVG_BASE + 25)	/* DMA2 2  (SPORT1 RX)	    */
#define	IRQ_SPORT1_TX		(IVG_BASE + 26)	/* DMA2 3  (SPORT2 TX)	    */
#define	IRQ_SPI			(IVG_BASE + 27)	/* DMA2 4  (SPI)	    */
#define	IRQ_UART_RX		(IVG_BASE + 28)	/* DMA2 5  (UART RX)	    */
#define	IRQ_UART_TX		(IVG_BASE + 29)	/* DMA2 6  (UART TX)	    */
#define	IRQ_PROG_INTA		(IVG_BASE + 47)	/* Programmable Flags0 A (8)*/
#define	IRQ_PROG_INTB		(IVG_BASE + 48)	/* Programmable Flags0 B (8)*/
#define IRQ_DMA_WRRD0		(IVG_BASE + 53) /* MDMA1 0 write/read INT   */
#define IRQ_DMA_WRRD1		(IVG_BASE + 54) /* MDMA1 1 write/read INT   */
