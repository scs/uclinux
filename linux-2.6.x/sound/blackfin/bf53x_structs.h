...
//#pragma pack(2)
struct bf53x_sport {
  unsigned short TCR1;    unsigned short _dum2; // 0x00 Transmit Configuration 1 Register
  unsigned short TCR2;    unsigned short _dum6; // 0x04 Transmit Configuration 2 Register
  unsigned short TCLKDIV; unsigned short _duma; // 0x08 Transmit Clock Divider
  unsigned short TFSDIV;  unsigned short _dume; // 0x0C Transmit Frame Sync Divider
  unsigned long  TX;                      // 0x10 TX Data Register
  unsigned long _dum14; 
  unsigned long  RX;                      // 0x18 RX Data Register
  unsigned long _dum1c; 
                  
  unsigned short RCR1;    unsigned short _dum22; // 0x20 Transmit Configuration 1 Register
  unsigned short RCR2;    unsigned short _dum26; // 0x24 Transmit Configuration 2 Register
  unsigned short RCLKDIV; unsigned short _dum2a; // 0x28 Receive Clock Divider
  unsigned short RFSDIV;  unsigned short _dum2e; // 0x2C Receive Frame Sync Divider
                  
  unsigned short STAT;    unsigned short _dum32; // 0x30 Status Register
  unsigned short CHNL;    unsigned short _dum36; // 0x34 Current Channel Register
  unsigned short MCMC1;   unsigned short _dum3a; // 0x38 Multi-Channel Configuration Register 1
  unsigned short MCMC2;   unsigned short _dum3e; // 0x3C Multi-Channel Configuration Register 2
...
struct bf53x_dma {
  ...
  unsigned short CONFIG;   unsigned short duma;        // 0x08 Configuration Register
  unsigned long dumc;
  unsigned short X_COUNT;  unsigned short dum12;       // 0x10 X Count Register
  unsigned short X_MODIFY; unsigned short dum16;       // 0x14 X Modify Register
  unsigned short Y_COUNT;  unsigned short dum1a;       // 0x18 Y Count Register
  unsigned short Y_MODIFY; unsigned short dum1e;       // 0x1C Y Modify Register
  struct bf53x_dma*  CURR_DESC_PTR;        // 0x20 Current Descriptor Pointer Register
  void*    CURR_ADDR;                      // 0x24 Current Address Register
  unsigned short IRQ_STATUS; unsigned short dum2a;     // 0x28 Interrupt/Status Register
  unsigned short PERIPHERAL_MAP; unsigned short dum2e; // 0x2C Peripheral Map Register
  unsigned short CURR_X_COUNT; unsigned short dum32;   // 0x30 Current X Count Register
  unsigned short CURR_Y_COUNT; unsigned short dum3a;   // 0x38 Current Y Count Register
  unsigned long dum3c;
};
//#pragma pack()
