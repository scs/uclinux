...
# CONFIG_USER_BUSYBOX_CROND_CALL_SENDMAIL is not set
...
# CONFIG_USER_BUSYBOX_FANCY_ECHO is not set
...
# CONFIG_USER_BUSYBOX_FIND_NEWER is not set
...
CONFIG_USER_BUSYBOX_INSMOD_VERSION_CHECKING=y
...
CONFIG_USER_BUSYBOX_LS_COLOR=y
...
# CONFIG_USER_BUSYBOX_COMMAND_USERNAME_COMPLETION is not set
# CONFIG_USER_BUSYBOX_SH_STANDALONE_SHELL is not set
CONFIG_USER_BUSYBOX_SH_FANCY_PROMPT=y
# CONFIG_USER_BUSYBOX_SH_EXTRA_QUIET is not set
...
CONFIG_USER_BUSYBOX_SU=y
CONFIG_USER_BUSYBOX_SULOGIN=y
...
# CONFIG_USER_BUSYBOX_ROTATE_LOGFILE is not set
...
# CONFIG_USER_BUSYBOX_TRACEROUTE_VERBOSE is not set
...
CONFIG_USER_BUSYBOX_VI_OPTIMIZE_CURSOR=y
...
# CONFIG_BLACKFIN_USE_SHARED_FLAT is not set
# CONFIG_BLACKFIN_USE_FDPIC is not set
